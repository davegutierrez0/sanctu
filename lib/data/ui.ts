...
export const UI = {
  en: {
    ...
    massGuide: 'Mass Guide',
    massGuideDesc: 'Step-by-step Roman Rite participation guide for weekdays, Sundays, and feast days',
    morningPrayer: 'Morning Prayer',
    morningPrayerDesc: 'Lauds from the Liturgy of the Hours',
  ...
  es: {
    ...
    massGuide: 'Guía de la Misa',
    massGuideDesc: 'Guía paso a paso de participación en el Rito Romano',
    morningPrayer: 'Oración de la Mañana',
    morningPrayerDesc: 'Laudes de la Liturgia de las Horas',
