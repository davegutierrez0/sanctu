...
const COPY = {
  en: {
    ...
    description: 'Subscribe for Sanctu and Catholic tech updates, share feedback, or help keep Sanctu free.',
    subscribe: 'Subscribe for updates',
    feedback: 'Send feedback',
    support: 'Buy me a coffee',
    signupTitle: 'Stay close to what we are building',
    feedbackTitle: 'Help shape Sanctu',
    firstName: 'First name',
    email: 'Email address',
    replyEmail: 'Email for a reply (optional)',
    feedbackPrompt: 'What would make Sanctu more helpful for your prayer life?',
    addToUpdates: 'Also send me Sanctu and Catholic tech updates.',
  ...
  es: {
    ...
    description: 'Suscríbete a novedades de Sanctu y tecnología católica, envía comentarios o ayuda a mantener Sanctu gratuito.',
    subscribe: 'Suscribirme a novedades',
    feedback: 'Enviar comentarios',
    support: 'Invítame un café',
    signupTitle: 'Mantente cerca de lo que estamos creando',
    feedbackTitle: 'Ayuda a dar forma a Sanctu',
    firstName: 'Nombre',
    email: 'Correo electrónico',
    replyEmail: 'Correo para responder (opcional)',
    feedbackPrompt: '¿Qué haría que Sanctu fuera más útil para tu vida de oración?',
    addToUpdates: 'También quiero recibir novedades de Sanctu y tecnología católica.',
